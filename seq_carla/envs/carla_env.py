...
from why_carla.envs.render import BirdeyeRender
from why_carla.envs.route_planner import RoutePlanner
from why_carla.envs.misc import *
...
class CarlaEnv(gym.Env):
  ...
  def __init__(self, params):
    ...
    if 'change_weather' in params.keys():
  ...
  def choose_random_weather(self):
    avai_weathers = [carla.WeatherParameters.ClearNoon, carla.WeatherParameters.CloudyNoon,carla.WeatherParameters.WetNoon, 
    carla.WeatherParameters.WetCloudyNoon, carla.WeatherParameters.MidRainyNoon, carla.WeatherParameters.HardRainNoon, carla.WeatherParameters.SoftRainNoon,
    carla.WeatherParameters.ClearSunset, carla.WeatherParameters.CloudySunset, carla.WeatherParameters.WetSunset, carla.WeatherParameters.WetCloudySunset, carla.WeatherParameters.MidRainSunset,
    carla.WeatherParameters.HardRainSunset, carla.WeatherParameters.SoftRainSunset]
    chonsen_weather = avai_weathers[random.randint(0, len(avai_weathers)-1)]
    self.world.set_weather(chonsen_weather)
  ...
  def reset(self):
    ...
    #Change weather
    if self.change_weather:
      self.choose_random_weather()
  ...
  def step(self, action):
    ...
    # Apply control
    #规则先验
    # steer = 0. if abs(steer)<0.29 else steer
